...
import (
	...
	"github.com/gkwa/fewagent/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fewagent.yaml)")
